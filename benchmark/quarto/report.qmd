    ...
    include-in-header:
      text: |
        ...
        \renewcommand{\maketitle}{%
          ...
          \vspace{1em}
          {\normalfont\small\bfseries Keywords}\\[0.5em]
          \end{minipage}
...
sh_data <- tibble::tibble(
  tag          = c("aquavena.nc","v0.1.1","v0.1.2","v0.1.3","v0.1.4","v0.1.5","v1.5.0","v1.6.0","v1.7.0","v1.8.0","v1.9.0"),
  git_sha      = c(NA_character_, "0fdeff3","76658ae","9a5ca91","81fba2b","a59d12d","eccabc3","534854c","2e5e47e","9dc1a0b","dd2a22b"),
  audit_date   = as.Date(c("2026-05-30","2026-05-29","2026-05-30","2026-05-30",
                            "2026-05-30","2026-05-30","2026-05-30","2026-05-30","2026-05-30","2026-05-31","2026-05-31")),
  lh_score     = c(91L, 82L, 86L, 89L, 93L, 96L, 98L, 100L, 100L, 100L, 100L),
  pa11y_errors = c(67L,  5L,  3L,  2L,  1L,  0L,  0L,   0L,   0L,   0L,   0L),
  lines_delta  = c(0L, 17352L, 13L, 28L, 10L, 95L, 308L, 1240L, 919L, 0L, 0L)
)
...
gr_data <- tibble::tibble(
  tag          = c("v0.1.1","v0.1.2","v0.1.3","v0.1.4","v0.1.5","v1.5.0","v1.6.0","v1.7.0","v1.8.0","v1.9.0"),
  release_name = c(
  ...
  published_at    = as.Date(c("2026-05-29","2026-05-30","2026-05-30","2026-05-30",
                               "2026-05-30","2026-05-30","2026-05-30","2026-05-30","2026-05-31","2026-05-31")),
  published_at_ts = as.POSIXct(c("2026-05-29 23:58:03","2026-05-30 00:02:20","2026-05-30 00:14:10",
                                  ...
                                  "2026-05-30 03:52:36","2026-05-30 04:26:04","2026-05-30 17:49:08","2026-05-31 17:55:00"), tz = "UTC"),
  url           = c(
  ...
  author        = rep("adriens", 10),
  is_prerelease = rep(FALSE, 10),
  body_excerpt  = c(
