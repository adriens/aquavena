...
Low vision is one accessibility challenge among many. The same pipeline —
automated audit → structured score → database → report — applies without
modification to other user profiles:
