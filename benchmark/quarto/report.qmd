...
", sprintf("{\\Large\\textbf{%s/day}} & {\\Large\\textbf{%s\\,min}} \\\\\n",
  deploys_per_day, median_lead),
"Deployment Frequency & Lead Time for Changes \\\\
\\small\\color{teal700}\\itshape Elite & \\small\\color{teal700}\\itshape Elite \\\\
\\bottomrule
\\end{tabular}
\\end{center}
```\n", sep = "")
...
Elite tier: on-demand deploys, lead time $<$ 1\,h.
\end{center}
